...
import { apiCreateBlog, apiEditBlog, apiGetBlog } from "../../../api/User";
...
const EditBlog = () => {
  ...
  const handleSubmitForm = async (data) => {
    ...
    if (quillRef.current) {
      ...
      formData.append("idBlog", blog?.idBlog);
  ...
  return (
    <div className="flex flex-col align-items-center">
      <h2 className="my-10 title font-bold text-3xl">Cập nhật bài viết</h2>
      <form
