...
const CreateTypeFertilizer = () => {
  ...
  return (
    <div className="flex flex-col align-items-center">
      ...
      <form className="w-full max-w-screen-xl flex flex-col gap-3" onSubmit={handleSubmit(onSubmit)}>
        <div className="flex flex-wrap -mx-3 mb-6">
          ...
          <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
            ...
            />
           {errors.nameTypeFertilizer && <span className="text-red-500 text-xs">{errors.nameTypeFertilizer.message}</span>}
          </div>
          ...
          <div className="w-full md:w-1/2 px-3">
            ...
            {errors.delete && <span className="text-red-500 text-xs">{errors.delete.message}</span>}
          </div>
